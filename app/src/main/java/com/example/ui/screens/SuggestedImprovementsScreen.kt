...
@Composable
fun SuggestedImprovementsScreen(
    ...
    LazyColumn(
        ...
        if (state.improvements.isEmpty()) {
            item {
                Box(
                    ...
                    Column(horizontalAlignment = androidx.compose.ui.Alignment.CenterHorizontally) {
                        ...
                        Text(
                            text = "No changes are currently recommended.",
            ...
            items(state.improvements) { improvement ->
                ImprovementReviewCard(
                    improvement = improvement,
                    onClick = { onNavigateToImprovement(improvement.id) }
                )
            }
        }
    }
